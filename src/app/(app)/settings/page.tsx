    ...
    { label: "Email", ok: mail.ok, warn: true, detail: mail.detail },
    {
      ...
      detail:
        env.AI_PROVIDER === "none"
          ? "not configured — editing, checks and exports all work without AI"
    ...
    <div className="mx-auto max-w-3xl px-4 py-8 lg:px-8">
      ...
      <div className="mt-6">
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          Full diagnostics{" "}
          {isDevelopment() ? "at /diagnostics" : "are limited in production to server operators"} —
